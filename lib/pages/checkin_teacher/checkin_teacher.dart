...
class _CheckinTeacherPageState extends State<CheckinTeacherPage> {
  ...
  void createSession() {
    // Tạo phiên điểm danh
    _teacherCubit.createSession(timeTableTeacherId: widget.timeTableTeacher.id);
  }
          ...
          children: [
            ...
            BlocProvider(
              create: (context) => _teacherCubit
                ..getSession(timeTableTeacherId: widget.timeTableTeacher.id),
                  ...
                  if (state is TeacherSessionLoaded) {
                    if (state.events != null) {
                      setState(() {
                        ...
                        notCheckinStudent = state.events!.notCheckinInStudent;
                      });
                    }
                  }
                                ...
                                child: Card(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Text(
                                          checkinStudent[index]!.fullName,
                                          style: const TextStyle(
                                              fontSize: 16,
                                              fontWeight: FontWeight.w600),
                                        ),
                                        Text(
                                          checkinStudent[index]!.email,
                                          style: const TextStyle(
                                              fontSize: 14,
                                              fontWeight: FontWeight.w400),
                                        ),
                                ...
                                child: Card(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Text(
                                          notCheckinStudent[index]!.fullName,
                                          style: const TextStyle(
                                              fontSize: 16,
                                              fontWeight: FontWeight.w600),
                                        ),
                                        Text(
                                          notCheckinStudent[index]!.email,
                                          style: const TextStyle(
                                              fontSize: 14,
                                              fontWeight: FontWeight.w400),
                                        ),
